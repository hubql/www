...
const ServicesCards = [
    {
        ...
        description:
            'We explore, prototype, and build cutting-edge software solutions that push the boundaries of technology. Our team helps companies experiment with new ideas, validate concepts, and bring innovative products to life.',
        list: [
    ...
    },
    {
        ...
        description:
            'We help engineering teams optimize their workflow, improve internal tooling, and enhance developer experience. Our solutions streamline documentation, automation, and efficiency in software development.',
        list: [
    ...
    },
    {
        ...
        description:
            'We create user-centered digital experiences that blend functionality with aesthetics. From wireframes to final UI/UX, we ensure that your product is intuitive, engaging, and built for success.',
        list: [
    ...
    },
    {
        ...
        description:
            'We build high-quality, modern web applications tailored to your business needs. Our expertise spans across front-end, back-end, and full-stack development using the latest technologies.',
        list: [
    ...
    },
    {
        ...
        description:
            'We craft high-quality APIs and provide automated documentation solutions to improve developer experience and streamline API adoption.',
        list: [
    ...
    },
    {
        ...
        description:
            'In collaboration with GROWSaaS, we help SaaS and tech companies scale with expert marketing strategies, performance campaigns, and SEO optimization.',
        list: [
