...
import { Sheet, SheetContent, SheetHeader, SheetTitle } from '../kit/Sheet'
...
export const DocsMenu = () => {
    ...
    return (
        <>
            <div className="fixed text-white h-full max-h-full w-[320px] left-0 bg-black z-10 border-r border-zinc-800 py-8 hidden lg:block mb-px overflow-y-auto">
