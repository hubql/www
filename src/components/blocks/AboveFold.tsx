...
export const AboveFold = ({
    ...
    data: PagesBlocksAboveFold
}) => {
    return(
        <div className="flex flex-wrap items-start w-fit gap-y-2 gap-x-2 justify-center p-[2px] rounded-sm mt-4"    >
            <motion.div
            className="pt-24 pb-24 absolute top-0 left-0 lg:relative w-fit h-fit flex flex-col z-10 px-8 max-lg:bg-black/10 max-lg:backdrop-blur-sm"
...
export const aboveFoldBlockSchema: Template = {
    ...
    ui:{
        ...
        defaultItem: {
            ...
            paragraph: "Hubql is a software services company delivering excellent web applications, APIs, and open-source tools. We help fast-moving teams build software with precision.",
            button: {
                label: "Build with us",
                link: '/contact',   
            },
