...
seoDescription: >-
  Visualize your API schema with Hubql and make it easy for your team to
...
blocks:
  - title: null
    ...
    richtext: >
      ...
      Turn your API schema in OpenAPI specification into a living document with
      Hubql.

      Visualize your API schema with Hubql and make it easy for your API
      consumers to understand your APIs.
    actions:
  ...
  - cards:
      - icon:
        ...
        paragraph: >
          We support OpenAPI spec either introspection via URL or through our
          server libraries passing your API schema. Hubql converts your API
          schema into a visual representation.
        link: ''
        colSpan: 4
      - icon:
        ...
        paragraph: >-
          Turn your GraphQL schema into a visual representation with Hubql.
          Visualize your GraphQL schema and make it easy for your team to
          understand and share.
        link: ''
        colSpan: 4
      - icon:
